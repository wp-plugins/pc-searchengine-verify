...
With this plugin there's no editing of files, just upload, activate, and add the meta tag info on the plugin options page under your Settings menu. All done.

== Installation ==

Once you have the plugin installed and activated, under your blog Settings menu, you'll see a new menu item called PC Search Engine Verify. Click that menu item for the plugin options page, where you can enter the meta tag information provided by the webmaster tools for your domain.
